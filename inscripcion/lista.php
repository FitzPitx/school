...
<head>
    ...
    <link rel="stylesheet" href="../public2/css/bootstrap.min.css">
...
<body style=" background-image: url('https://cdn.pixabay.com/photo/2021/10/06/05/17/learn-6684425__340.jpg');
    ...
    <div class="container" style="background-color: #ffffff">
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="../public2/img/logoEdunexus-removebg-preview.png" style="margin-top: 10px;float: right" width="100px" alt="">
            </div>
        </div>
        <br>
